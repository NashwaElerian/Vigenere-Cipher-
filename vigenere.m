...
% Last Modified by GUIDE v2.5 09-May-2023 17:18:36
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
plaintext=(get(handles.p,'string'))
k=(get(handles.x,'string'))
r=Enc_vigenere(plaintext,k)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
ciphertext=(get(handles.p2,'string'))
k=(get(handles.x2,'string'))
r2=Dec_vigenere(ciphertext,k)
...
s=' ';
sx=num2str(s);
set(handles.p,'string',(sx))
set(handles.x,'string',(sx))
set(handles.p2,'string',(sx))
set(handles.x2,'string',(sx))
set(handles.r,'string',(sx))
set(handles.r2,'string',(sx))
